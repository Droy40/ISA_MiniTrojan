...
namespace ClassLibrary
{
    public class HistorySaldo
    {
        ...
        private static string GenerateIdHistorySaldo()
        {
        ...
        public static List<HistorySaldo> BacaData(string filter = "", string nilai = "")
        {
            ...
            if(filter == "")
            {
                sql = "select * from History_Saldo";_
            }
            else
            {
